...
import { ZApiNotificationGateway } from "@/lib/notifications/whatsapp-notifier";
// controllers
...
export function createUsersModule() {
    ...
    const notificationGateway = new ZApiNotificationGateway();
    ...
    const recoverAccessService = new RecoverAccessService(repository, resetUserPasswordRepository, notificationGateway);
    ...
    const adminCreateController = new AdminCreateUserController(adminCreateService);
    const findAllUsersUserController = new FindAllUsersUserController(findAllUsersUserService);
    const recoverAccessController = new RecoverAccessController(recoverAccessService);
