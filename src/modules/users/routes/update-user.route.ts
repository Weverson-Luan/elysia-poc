...
import type { UpdateUserController } from "../controllers/update-user.controller";
import { updateUserBodySchema } from "../dtos/update-user.dto";

function createUpdateUserRoute(updateUserController: UpdateUserController) {
  return createAuthRoute("update-me").patch(
    "/update-me",
