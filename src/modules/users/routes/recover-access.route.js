...
function createRecoverAccessRoute(recoverAccessController) {
    return new Elysia({ name: "recover-access", prefix: "/users" }).post("/recover-access", async ({ body, set, request }) => {
        try {
